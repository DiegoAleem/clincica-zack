...
export class PerfilService {
  ...
  getPerfil(id: string): Observable<any> {
    return this.http.get<any>(`https://www.clinicazack.com.br/api/perfil/${id}`, { headers: this.getHeader() }).pipe(
  ...
  getPerfilFiltroAvaliacao(filtro: any): Observable<any> {
    ...
    return this.http.get<any>(
        'https://www.clinicazack.com.br/api/perfil/filtrados-melhor-avaliados', 
  ...
  getMaisAvalidaosPerfil() {
    return this.http.get<any>(`https://www.clinicazack.com.br/api/perfil/top-rated`, { headers: this.getHeader() }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }

  getPerfilPorUsuario(id: string): Observable<any> {
    return this.http.get<any>(`https://www.clinicazack.com.br/api/perfil/buscarPorUsuario/${id}`, { headers: this.getHeader() }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
  ...
  getPerfis(pagina: number, filtro: string, campoOrdenado: string, ordemAscendente: string): Observable<any> {
    ...
    return this.http.get<any[]>('https://www.clinicazack.com.br/api/perfil/filtrados', { headers: this.getHeader(), params: params }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
  ...
  getAllPerfis(pagina: number, filtro: string, campoOrdenado: string, ordemAscendente: string): Observable<any> {
    ...
    return this.http.get<any[]>('https://www.clinicazack.com.br/api/perfil/all-filtrados', { headers: this.getHeader(), params: params }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
  ...
  salvarPerfil(json: string, foto: File | undefined) {
    ...
    return this.http.put<any>(`https://www.clinicazack.com.br/api/perfil/editar`, formData, { headers: this.getHeader() }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
  ...
  desativarUsuario(id: number, usuario: String | null): Observable<any> {
    ...
    return this.http.put<any>(`https://www.clinicazack.com.br/api/usuario/desativar/${id}/${usuario}`, null, { headers: this.getHeader() }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
  ...
  ativarUsuario(id: number, usuario: String | null): Observable<any> {
    ...
    return this.http.put<any>(`https://www.clinicazack.com.br/api/usuario/ativar/${id}/${usuario}`, null, { headers: this.getHeader() }).pipe(
      catchError((error: any) => this.handleError(error))
    );
  }
